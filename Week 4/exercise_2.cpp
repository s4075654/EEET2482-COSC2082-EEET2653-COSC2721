...
public:
  ...
  friend void c(int argc, char *command_line_argument, BankAcc *all_data,
                unsigned long long int account);
};

void c(int not_give_the_command_line_argument, char *command_line_argument,
       BankAcc *all_data, unsigned long long int account) {
...
int main(int argc, char **argv) {
  ...
  printf("%f %s %f %s %f %s\n", bank_account_object_1.amount,
         bank_account_object_1.name, bank_account_object_2.amount,
         bank_account_object_2.name, bank_account_object_3.amount,
         bank_account_object_3.name);
