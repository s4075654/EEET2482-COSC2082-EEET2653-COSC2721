...
class AClassTemplate {
  ...
  AGenericType* find(AGenericType an_element) {
    ...
    for(auto an_element_of_the_vector = a_vector_attribute_of_a_generic_type.begin(); an_element_of_the_vector != a_vector_attribute_of_a_generic_type.end(); ++an_element_of_the_vector) {
...
int main(int argc, char **argv) {
  ...
  for(auto an_element_of_the_vector = type_int.a_vector_attribute_of_a_generic_type.begin(); an_element_of_the_vector != type_int.a_vector_attribute_of_a_generic_type.end(); ++an_element_of_the_vector) {
  ...
  for(auto an_element_of_the_vector = type_double.a_vector_attribute_of_a_generic_type.begin(); an_element_of_the_vector != type_double.a_vector_attribute_of_a_generic_type.end(); ++an_element_of_the_vector) {
