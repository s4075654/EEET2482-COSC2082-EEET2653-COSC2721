...
ptrdiff_t* enter_values_for_them(ptrdiff_t *an_array_of_5_integers) {
  ...
  puts("Enter values: ");
  scanf("%td %td %td %td %td", an_array_of_5_integers, an_array_of_5_integers + 1, an_array_of_5_integers + 2, an_array_of_5_integers + 3, an_array_of_5_integers + 4);

  return(an_array_of_5_integers);
}

void print_out_the_maximum_value_and_their_average(ptrdiff_t *an_array_of_5_integers) {
