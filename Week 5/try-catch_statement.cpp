...
void b() {
  FILE *a_loop_that_continuously_request_1MB_from_the_heap =
      fopen("a_loop_that_continuously_request_1MB_from_the_heap.cpp", "w");
  ...
  fputs("  while(1) {\n", a_loop_that_continuously_request_1MB_from_the_heap);
  fputs("    try {\n", a_loop_that_continuously_request_1MB_from_the_heap);
  fputs("      char *an_array_of_char = (char *)mmap(NULL, 1024 * 1024 * "
        "sizeof(char), PROT_READ, MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);\n",
        a_loop_that_continuously_request_1MB_from_the_heap);
  ...
  fputs("    }\n", a_loop_that_continuously_request_1MB_from_the_heap);
  fputs(
      "    catch(char *the_exception_to_stop_the_loop_if_allocation_fails) {\n",
      a_loop_that_continuously_request_1MB_from_the_heap);
  fputc('\n', a_loop_that_continuously_request_1MB_from_the_heap);
  fputs("      munmap(the_exception_to_stop_the_loop_if_allocation_fails, 1024 "
        "* 1024 * sizeof(char));\n",
        a_loop_that_continuously_request_1MB_from_the_heap);
